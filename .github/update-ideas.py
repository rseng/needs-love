...
def get_filepath():
    ...
    '''
    filepath = os.path.join(os.path.dirname(here), '_data', 'ideas.csv')
...
def main():
    ...
    sheet = "https://docs.google.com/spreadsheets/d/e/2PACX-1vQAOOBsA-WZEnhCl31FvX2RfAY1HiXsdnBo99iHHTculFEClAVsGHWxCd3qvBdUXQ67BcWjSjoCQ5i5/pub?gid=2031791408&single=true&output=csv"
    ...
    with open(filepath, 'a+') as filey:
        ...
        for line in csv.reader(lines[1:], quotechar='"', delimiter=',',
            ...
            if timestamp not in timestamps:
                writer.writerow([timestamp, github_user, challenge, description])
